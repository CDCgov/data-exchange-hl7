...
abstract class ProcessMetadata(
    ...
    constructor(processName:String, processVersion:String, status: String?, eventHubMetadata: EventHubMetadata ):
            this(processName, processVersion, eventHubMetadata.EnqueuedTimeUtc, eventHubMetadata.Offset, eventHubMetadata.SequenceNumber, status)
}
