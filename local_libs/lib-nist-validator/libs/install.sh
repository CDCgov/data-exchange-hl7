...
mvn deploy:deploy-file -DrepositoryId=nexus -Durl=https://imagehub.cdc.gov/repository/maven-ede-snapshot/ -Dfile=hl7-v2-profile-$NIST_VERSION.jar -DgroupId=gov.nist -DartifactId=hl7-v2-profile -Dversion=$NIST_VERSION -Dpackaging=jar -DpomFile=hl7-v2-profile-$NIST_VERSION.pom
