...
class Function {
    ...
    fun eventHubCASEProcessor(
        ...
        return processMessages(message, context, eventHubMD)
    ...
    private fun processMessages(message: List<String?>, context: ExecutionContext, eventHubMD: List<EventHubMetadata>) : JsonObject {
