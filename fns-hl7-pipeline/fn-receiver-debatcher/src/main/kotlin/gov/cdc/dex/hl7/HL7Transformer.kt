...
class HL7Transformer (
    ...
    fun removeBinary(): List<String> {
        ...
        val blobUrl = uploadBinaryDataToBlob(binaryData, metadata) ?: return hl7Message
     ...
     */
    private fun uploadBinaryDataToBlob(data: BinaryData,metadata : Map<String,String?>): String? {
        return try {
            ...
            attachmentBlob.setMetadata(metadata)
