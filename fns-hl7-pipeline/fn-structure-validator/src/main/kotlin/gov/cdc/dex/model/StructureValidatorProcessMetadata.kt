...
data class StructureValidatorProcessMetadata (override val status: String, val report: NistReport?, @Transient val eventHubMD: EventHubMetadata, val config : List<String>): ProcessMetadata(
